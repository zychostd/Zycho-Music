...
from Music.MusicUtilities.database.chats import is_served_chat, add_served_chat
...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("ᴄᴏᴍᴍᴀɴᴅ​", url="https://telegra.ph/Daftar-Perintah-Bot-Music-08-18"),
        ],
    ]
    return (
...
async def play(_, message: Message):
    if len(message.command) == 1:
        ...
        await app.send_photo(
            message.chat.id,
            photo="https://telegra.ph/file/b85591ac0a107edf28190.jpg",
            caption=f"""Hallo {rpk}!
