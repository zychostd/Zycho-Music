    ...
    if not message.reply_to_message:
        ...
        if user.id == from_user.id:
            ...
            m = await message.reply_text(
                f"""
**Memulai proses GBan {user.mention}**
di {len(served_chats)} Group.
"""
            )
            number_of_chats = 0
            for sex in served_chats:
                try:
                    ...
                    pass
            ban_text = f"""
__**Global Ban Berhasil**__
**Perintah Dari :** {from_user.mention}
*User :** {user.mention}
**ID :** `{user.id}`
Pengguna Telah Di Ban Dari **{number_of_chats}** Group
"""
            try:
                await m.delete()
            except Exception:
...
**Perintah Dari :** {from_user_mention}
*User :** {mention}
**ID :** `{user_id}`
Pengguna Telah Di Ban Dari **{number_of_chats}** Group
